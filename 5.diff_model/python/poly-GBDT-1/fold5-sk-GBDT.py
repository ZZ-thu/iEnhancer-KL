...
dataFile = r'C:\workspace\PycharmProjects\task-2019-9-11\poly-GBDT-1\pstnp.mat'
data = scio.loadmat(dataFile)
X=data['pstnp']

labelFile=r'C:\workspace\PycharmProjects\task-2019-9-11\poly-GBDT-1\label.mat'
label=scio.loadmat(labelFile)

y=label['label']
rankFile = r'C:\workspace\PycharmProjects\task-2019-9-11\poly-GBDT-1\indices.mat'
