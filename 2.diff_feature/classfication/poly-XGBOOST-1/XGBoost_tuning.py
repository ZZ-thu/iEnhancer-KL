...
# read in the data
dataFile = r'C:\workspace\PycharmProjects\poly-XGBOOST-1\data_lasso.mat'
data = scio.loadmat(dataFile)
X = data['data_lasso']
labelFile = r'C:\workspace\PycharmProjects\poly-XGBOOST-1\label.mat'
label = scio.loadmat(labelFile)
y = label['label']
rankFile = r'C:\workspace\PycharmProjects\poly-XGBOOST-1\indices.mat'
...
if __name__ == '__main__':
    # cv_params ={'n_estimators': range(100,501,10)}
    ...
    other_params = {'learning_rate': 0.0008, 'n_estimators': 200, 'max_depth': 7,
    ...
    print('Results of each round of iteration:{0}'.format(evalute_result))
