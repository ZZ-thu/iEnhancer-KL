...
# read in the data
dataFile = r'C:\workspace\PycharmProjects\task-2019-9-01\poly-XGBOOST-1\pstnp.mat'
data = scio.loadmat(dataFile)
X = data['pstnp']
labelFile = r'C:\workspace\PycharmProjects\task-2019-9-01\poly-XGBOOST-1\label.mat'
label = scio.loadmat(labelFile)
y = label['label']
rankFile = r'C:\workspace\PycharmProjects\task-2019-9-01\poly-XGBOOST-1\indices.mat'
...
if __name__ == '__main__':
    ...
    other_params = {'learning_rate': 0.0008, 'n_estimators': 490, 'max_depth': 7,
